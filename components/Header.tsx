...
interface HeaderProps {
  ...
  onGearInstaDocClick: () => void;
}

const Header: React.FC<HeaderProps> = ({ onSettingsClick, onWorkbenchClick, onEditorPlusClick, onGearInstaDocClick }) => {
  return (
